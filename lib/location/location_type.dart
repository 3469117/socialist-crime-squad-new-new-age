...
enum SiteType {
  ...
  departmentStore("Superstore", "Big-Box Store"),
  ...
  tenement("Public Hsg.", "Public Housing"),
  ...
  amRadioStation("Talk Radio", "Talk Radio Network"),
  cableNewsStation("News Net", "News Network HQ"),
  drugHouse("Drug House", "Drug House"),
  juiceBar("Juice Bar", "Juice Bar"),
  latteStand("Coffee", "Coffee Kiosk"),
  veganCoOp("Vegan", "Vegan Co-op"),
  internetCafe("Cowork", "Coworking Space"),
  ...
  liberalPartyHQ("Soc. HQ", "Socialist Party HQ"),
