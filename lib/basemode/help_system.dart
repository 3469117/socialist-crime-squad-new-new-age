  ...
  switch (type) {
    ...
    case ActivityType.writeGuardian:
      ...
      _body("The Socialist Guardian is the SCS's independent media platform. "
          "It now develops as an institution with its own Reach, Credibility, "
          "and Editorial Capacity instead of depending entirely on SCS "
          "popularity.\n\n"
          "When assigning a publisher, choose an editorial beat. Routine "
          "stories will concentrate on issues inside that beat rather than a "
          "random political subject. General Assignment keeps the old broad "
          "approach.\n\n"
          "Publishing uses Writing plus Law, Science, Religion, and Business. "
          "Written work is the Guardian's best way to build Credibility and "
          "newsroom capacity. Strong reporting also grows Reach, but more "
          "slowly than live video. Credibility makes future written reporting "
          "more persuasive.\n\n"
          "Editorial Capacity determines how many Guardian staff can work at "
    ...
    case ActivityType.streamGuardian:
      ...
      _body("Livestreaming is the Guardian's fast, audience-facing form of "
          "coverage and requires a video studio. Like publishing, you choose "
          "an editorial beat when assigning the activity.\n\n"
          "Livestreaming uses Persuasion plus Law, Science, Religion, and "
          "Business. It produces stronger immediate audience growth than "
          "written publishing and is the fastest way to build Guardian Reach. "
          "It is no longer a flat four-times multiplier: its effectiveness "
          "depends increasingly on the audience the Guardian has actually "
          "built.\n\n"
          "Streaming can also improve Editorial Capacity, but it builds "
          "Credibility much more slowly than careful written work. Maintaining "
